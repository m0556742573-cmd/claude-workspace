...
מחזיקה פרטי גישה של הלקוח למערכות כספיות (למשל חשבשבת) — נדרש לעבודה השוטפת של הנהלת החשבונות מול מערכות הלקוח. מידע רגיש ביותר. מבנה זהה ל-`client_professional_credentials`, טבלה נפרדת בכוונה (עיקרון blast-radius אבטחתי — ר' שם לנימוק המלא).
